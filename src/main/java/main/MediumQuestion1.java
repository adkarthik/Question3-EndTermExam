...
class SeniorCitizenCustomer extends Customer {
	...
	Double getBillAmount(Double amount) {
		Double bill =amount-((12*amount)/100); //edit as per the question
...
class PrivilegeCustomer extends Customer {
	PrivilegeCustomer(String name, String address, Integer age, String mobile) {
		...
		Double getBillAmount(Double amount) {
			Double bill =amount-((30*amount)/100); //edit as per the Question 
	...
	public static void main(String[] args) {
		...
		switch (select) {
			case 1:
				...
				System.out.println(cust.toString()+"\n"+"Your bill amount is Rs. "+purchasedAmt+". Congrats! As you are a Privileged customer, you are eligible for a discount!\r\n" + 
